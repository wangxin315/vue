  ...
  <div class="wrapper" :class="{'nav-open': $sidebar.showSidebar}">
    ...
    <side-bar>
      ...
      <template slot-scope="props" slot="links">
        <sidebar-item v-if="!auth" :link="{name: 'Signin', icon: 'nc-icon nc-button-power', path: '/admin/signin'}">
        </sidebar-item>
        <sidebar-item v-if="!auth" :link="{name: 'Signup', icon: 'nc-icon nc-notes', path: '/admin/signup'}">
        </sidebar-item>
        
        <sidebar-item :link="{name: 'Dashboard', icon: 'nc-icon nc-chart-pie-35', path: '/admin/overview'}">
        </sidebar-item>
        <sidebar-item :link="{name: 'Add a car', icon: 'nc-icon nc-bus-front-12', path: '/admin/addlisting'}">
        </sidebar-item>
